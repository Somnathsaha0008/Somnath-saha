...
export const CommerceIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className={iconClass} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-7.5a.75.75 0 01.75-.75h3a.75.75 0 01.75.75V21m-4.5 0H2.25a.75.75 0 01-.75-.75v-9a.75.75 0 01.75-.75h21a.75.75 0 01.75.75v9a.75.75 0 01-.75.75h-5.25m-4.5 0h-4.5" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 7.5l3 3.75 3-3.75" />
    </svg>
);
