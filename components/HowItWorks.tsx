...
import { DataIcon, AnalysisIcon, SignalIcon, SyncIcon } from './icons/FeatureIcons';
...
const StepCard: React.FC<StepCardProps> = ({ icon, title, description, delay }) => (
  <div className="bg-gray-800/50 p-6 rounded-lg text-center animate-fade-in-up" style={{ animationDelay: delay }}>
    ...
    <section className="py-20 bg-gray-900">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 mt-2">A four-step process for intelligent traffic management.</p>
        </div>
